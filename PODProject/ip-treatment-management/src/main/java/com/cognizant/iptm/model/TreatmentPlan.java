...
public class TreatmentPlan {
	...
	public TreatmentPlan(@NotNull long treatmentPlanId, PatientDetail patientDetail, String packageName,
			String testDetail, String status, double cost, String specialist, String treatmentCommencementDate,
	...
	public TreatmentPlan(PatientDetail patientDetail, String packageName,
			String testDetail, String status, double cost, String specialist, String treatmentCommencementDate,
			String treatmentEndDate) {
		super();
		this.patientDetail = patientDetail;
